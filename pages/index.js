...
import { getAuthors } from '../datalayer'
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 block text-sm font-medium text-gray-700">
        This is a temporary placeholder for testing the layout. Future blog
        posts and side menu will be placed here in the future.
      </div>
    </button>
  )
}
